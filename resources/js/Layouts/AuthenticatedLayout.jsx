    ...
    >
      ...
      <nav className="bg-gray-900 text-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 flex items-center justify-between h-20">
          ...
          <nav className="hidden lg:flex items-center space-x-6">
            ...
            <div className="relative">
              <Dropdown>
                <Dropdown.Trigger>
                  <button
                    ...
                    className={`inline-flex items-center px-3 py-2 rounded-md text-sm font-medium transition-colors cursor-pointer ${
                      ...
                      route().current("archived-courses.*")
                        ? "bg-purple-600"
                        : "hover:bg-gray-800"
                    }`}
                  >
                ...
                <Dropdown.Content>
                  <Dropdown.Link href={route("courses.index")}>
                    📋 All Courses
                  </Dropdown.Link>
                  <Dropdown.Link href={route("archived-courses.index")}>
                    📚 Course Archives
                  </Dropdown.Link>
                  <Dropdown.Link href={route("courses.create")}>
                    ➕ Create Course
                  </Dropdown.Link>
                </Dropdown.Content>
              </Dropdown>
            ...
            <Dropdown>
              <Dropdown.Trigger>
                <button
                  className={`px-3 py-2 rounded-md text-sm font-medium transition-colors relative cursor-pointer flex items-center ${
                    route().current("clients.*") ||
                    route().current("potential-clients.*")
                      ? "bg-gray-700"
                      : "hover:bg-gray-800"
                  }`}
                >
              ...
              <Dropdown.Content>
                ...
                <Dropdown.Link href={route("potential-clients.index")}>
                  💡 Potential Clients
                </Dropdown.Link>
                <Dropdown.Link href={route("certificates.index")}>
                  🏆 Certificates
                </Dropdown.Link>
                <Dropdown.Link href={route("clients.reports")}>
                  📊 All Client Reports
                </Dropdown.Link>
                <Dropdown.Link href={route("reports.training-clients")}>
                  🎯 Training Reports
                </Dropdown.Link>
                <Dropdown.Link href={route("reports.business-clients")}>
                  🏢 Business Reports
                </Dropdown.Link>
                <Dropdown.Link href={route("reports.system-users")}>
            ...
            <Link
              ...
              className={`px-3 py-2 rounded-md text-sm font-medium transition-colors relative cursor-pointer ${
                route().current("tasks.*") ? "bg-gray-700" : "hover:bg-gray-800"
              }`}
            >
              📋 Tasks
              {route().current("tasks.*") && (
            ...
            <div className="relative">
              <Dropdown>
                ...
                <Dropdown.Content>
                  <Dropdown.Link href={route("logistics.index")}>
                    🚀 Logistics
                  </Dropdown.Link>
                  <Dropdown.Link href={route("operations.attendance")}>
                    📋 Attendance
                  </Dropdown.Link>
                  <Dropdown.Link href={route("messages.index")}>
                    💬 Messages
                  </Dropdown.Link>
                  <Dropdown.Link href={route("catering.index")}>
                    🍽️ Catering
                  </Dropdown.Link>

                  <Dropdown.Link href={route("transportation.index")}>
                    🚗 Vehicle Rental
                  </Dropdown.Link>
                  <Dropdown.Link href={route("asset-management.index")}>
                    🏢 Manage Assets
                  </Dropdown.Link>
                  <Dropdown.Link href={route("user-management.index")}>
                    👥 User Management
                  </Dropdown.Link>
                  <Dropdown.Link href={route("financial-management.index")}>
            ...
            <div className="relative">
              <Dropdown>
                ...
                <Dropdown.Content>
                  <Dropdown.Link href={route("management.index")}>
                    🎯 System Management
                  </Dropdown.Link>
                  <Dropdown.Link href={route("departments.index")}>
                    🏢 Departments
                  </Dropdown.Link>
                  <Dropdown.Link href={route("role-management.index")}>
                    👥 Roles
                  </Dropdown.Link>
                  <Dropdown.Link
                  ...
                  <Dropdown.Link href={route("training-halls.index")}>
                    🏢 Training Halls
                  </Dropdown.Link>
                  <Dropdown.Link href={route("hall-bookings.index")}>
                    📅 Hall Bookings
                  </Dropdown.Link>
                  <Dropdown.Link
                    href={route("catering.meal-break-plans.index")}
                  >
                    📅 Meal Break Plans
                  </Dropdown.Link>
                  <Dropdown.Link href={route("certificates.index")}>
              ...
              <Dropdown>
                ...
                <Dropdown.Content>
                  ...
                  <div className="px-4 py-2 text-xs text-gray-500 border-t border-gray-100">
                    <div className="font-medium">PMEC ACMS v2.0</div>
                    <div>Laravel 12.24 • React 18 • JSX</div>
          ...
          <div className="lg:hidden">
            ...
            >
              <svg
                className={`${showingMobileMenu ? "hidden" : "block"} h-6 w-6`}
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
              ...
              <svg
                className={`${showingMobileMenu ? "block" : "hidden"} h-6 w-6`}
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              ...
              <div className="px-3 py-2">
                ...
                <div className="space-y-1">
                  ...
                  <ResponsiveNavLink
                    ...
                    active={route().current("archived-courses.*")}
                    className="block px-3 py-2 rounded-md text-base font-medium text-white hover:bg-gray-700"
                  >
                    📚 Course Archives
                  </ResponsiveNavLink>
              ...
              <div className="space-y-1">
                ...
                <ResponsiveNavLink
                  ...
                  className="block px-6 py-2 rounded-md text-base font-medium text-white hover:bg-gray-700"
                >
                  👥 Current Clients
                </ResponsiveNavLink>
                <ResponsiveNavLink
                  href={route("potential-clients.index")}
                  active={route().current("potential-clients.*")}
                  className="block px-6 py-2 rounded-md text-base font-medium text-white hover:bg-gray-700"
                >
                  💡 Potential Clients
                </ResponsiveNavLink>
                <ResponsiveNavLink
                  ...
                  active={route().current("clients.reports")}
                  className="block px-6 py-2 rounded-md text-base font-medium text-white hover:bg-gray-700"
                >
                  📊 All Client Reports
                </ResponsiveNavLink>
                <ResponsiveNavLink
                  href={route("reports.training-clients")}
                  active={route().current("reports.training-clients")}
                  className="block px-6 py-2 rounded-md text-base font-medium text-white hover:bg-gray-700"
                >
                  🎯 Training Reports
                </ResponsiveNavLink>
                <ResponsiveNavLink
                  href={route("reports.business-clients")}
                  active={route().current("reports.business-clients")}
                  className="block px-6 py-2 rounded-md text-base font-medium text-white hover:bg-gray-700"
                >
                  🏢 Business Reports
                </ResponsiveNavLink>
                <ResponsiveNavLink
                  href={route("reports.system-users")}
                  active={route().current("reports.system-users")}
                  className="block px-6 py-2 rounded-md text-base font-medium text-white hover:bg-gray-700"
                >
                  👨‍💼 System Users Reports
                </ResponsiveNavLink>
      ...
      <footer className="bg-slate-800 text-gray-300 py-3 sm:py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 text-center text-xs sm:text-sm">
          © {new Date().getFullYear()} PMEC — Professional Management Expertise
          Center
        </div>
      </footer>
    </div>
