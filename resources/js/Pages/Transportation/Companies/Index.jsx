...
export default function CompaniesIndex({ companies, stats }) {
    ...
    const handleToggleStatus = (companyId) => {
        toggleForm.patch(route('transportation.companies.toggle-status', companyId));
    };

    const handleToggleVerification = (companyId) => {
        toggleForm.patch(route('transportation.companies.toggle-verification', companyId));
    };

    const handleToggleFeatured = (companyId) => {
        toggleForm.patch(route('transportation.companies.toggle-featured', companyId));
    };
                    ...
                    <div className="mb-8 flex items-center justify-between">
                        <div>
                            ...
                            <p className="mt-2 text-gray-600 dark:text-gray-400">
                                Manage vehicle rental companies, their fleets, contacts, and partnerships.
                            </p>
                        </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {companies.map((company) => (
                            ...
                            >
                                ...
                                <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                                    <div className="flex items-start justify-between mb-4">
                                        ...
                                        <div className="flex flex-col space-y-1">
                                            <span className={`px-2 py-1 text-xs font-medium rounded-full ${company.status_badge.class}`}>
                                    ...
                                    <div className="text-sm text-gray-600 dark:text-gray-400 space-y-1">
                                        {company.city && (
                                            <p><span className="font-medium">📍 Location:</span> {company.city}{company.state && `, ${company.state}`}</p>
                                        )}
                                        {company.primary_phone && (
                                            <p><span className="font-medium">📞 Phone:</span> {company.primary_phone}</p>
                                        )}
                                        {company.primary_email && (
                                            <p><span className="font-medium">📧 Email:</span> {company.primary_email}</p>
                                        )}
                                    </div>
                                </div>
                                ...
                                {/* Services */}
                                {company.services_offered && company.services_offered.length > 0 && (
                                    <div className="p-6 border-b border-gray-200 dark:border-gray-700">
                                        <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-3">
                                            Services
                                        </h4>
                                        <div className="flex flex-wrap gap-2">
                                            {company.services_offered.slice(0, 3).map((service, index) => (
                                                <span
                                                    key={index}
                                ...
                                <div className="p-6">
                                    <div className="flex flex-col space-y-2">
                                        <div className="flex space-x-2">
                                            ...
                                            <Link
                                                href={route('transportation.companies.edit', company.id)}
                                        ...
                                        >
                                            {company.is_featured ? "⭐ Remove Featured" : "⭐ Make Featured"}
                                        </button>
                                    </div>
                                </div>
                            </div>
                    ...
                    {companies.length === 0 && (
                        <div className="text-center py-12">
                            ...
                            <p className="text-gray-500 dark:text-gray-400 mb-4">
                                Start building your rental network by adding your first company partner.
                            </p>
                            <Link
                                href={route('transportation.companies.create')}
