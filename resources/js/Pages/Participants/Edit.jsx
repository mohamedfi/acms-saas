...
export default function Edit({ participant }) {
    ...
    useEffect(() => {
        ...
        // Fetch enrolled courses for this participant
        fetch(`/api/participants/${participant.id}/enrollments`)
            .then((response) => response.json())
            .then((data) => {
                const enrolledCourseIds = data.data.map(
                    (enrollment) => enrollment.course_id
                );
                setData("course_ids", enrolledCourseIds);
            ...
            header={
                <div className="flex justify-between items-center">
                    <h2 className="text-xl font-semibold leading-tight text-gray-800 dark:text-gray-200">
                        ✏️ Edit Participant: {participant.full_name}
                    </h2>
                    <Link
                                    ...
                                    <div className="flex items-center space-x-6">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                                                JPG, PNG, GIF up to 5MB. Leave
                                                empty to keep current image.
                                            </p>
                                            ...
                                            <div className="mt-1 p-3 bg-gray-100 dark:bg-gray-600 rounded-md">
                                                ...
                                                {participant.nationality && (
                                                    <p className="text-sm font-medium text-indigo-600 dark:text-indigo-400 mt-2">
                                                        ...
                                                        →{" "}
                                                        {participant.nationality.toLowerCase() ===
                                                        "egyptian"
                                                            ? "Not Required"
                                                            : "Required"}
                                                    </p>
